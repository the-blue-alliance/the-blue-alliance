...
},{"./lib/React":53}],167:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
var classNames = require('classnames');

var GamedayFrame = React.createClass({displayName: "GamedayFrame",
  getInitialState: function() {
    return {
      chatEnabled: false,
      displayedWebcasts: [],
  ...
  render: function() {
    return (
      React.createElement("div", {className: "gameday container-full"}, 
        React.createElement(GamedayNavbar, {
        ...
        React.createElement(HashtagPanel, {enabled: this.state.hashtagEnabled}), 
        React.createElement(ChatPanel, {enabled: this.state.chatEnabled}), 
        ...
        React.createElement(FollowingTeamsModal, {
...
var GamedayNavbar = React.createClass({displayName: "GamedayNavbar",
  render: function() {
    return (
      React.createElement("nav", {className: "navbar navbar-default navbar-fixed-top", role: "navigation"}, 
        React.createElement("div", {className: "navbar-header"}, 
          ...
          React.createElement("a", {className: "navbar-brand", href: "#"}, "Gameday")
        ), 

        React.createElement("div", {className: "collapse navbar-collapse", id: "bs-example-navbar-collapse-1"}, 
          React.createElement("ul", {className: "nav navbar-nav navbar-right"}, 
            React.createElement(WebcastDropdown, {
            ...
            React.createElement("li", null, 
              React.createElement(BootstrapButton, {
                ...
                handleClick: this.props.onHashtagToggle}, "Hashtags")
            ), 
            React.createElement("li", null, 
              React.createElement(BootstrapButton, {
                active: this.props.chatEnabled, 
                handleClick: this.props.onChatToggle}, "Chat")
            ), 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: classes}, 
        React.createElement("iframe", {frameBorder: "0", scrolling: "no", id: "chat_embed", src: "http://twitch.tv/chat/embed?channel=tbagameday&popout_chat=true", height: "100%", width: "100%"})
      )
    );
  }
});

var HashtagPanel = React.createClass({displayName: "HashtagPanel",
  componentDidMount: function() {
    !function(d,s,id){
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: classes}, 
        React.createElement("div", {id: "twitter-widget"}, React.createElement("a", {className: "twitter-timeline", href: "https://twitter.com/search?q=%23omgrobots", "data-widget-id": "406597120632709121"}, "Tweets about \"#omgrobots\""))
      )
    );
  }
});
...
var BootstrapButton = React.createClass({displayName: "BootstrapButton",
  ...
  render: function() {
    ...
    return (
      React.createElement("a", {className: classes, href: this.props.a, onClick: this.handleClick}, this.props.children)
    );
  }
});

var VideoGrid = React.createClass({displayName: "VideoGrid",
            ...
            React.createElement("div", {className: "panel panel-default"}, 
              React.createElement("div", {className: "panel-body"}, 
                React.createElement("div", {className: "jumbotron"}, 
                  React.createElement("h2", null, "GameDay — Watch FIRST Webcasts"), 
                  React.createElement("p", null, "To get started, pick some webcasts from the top menu.")
                )
              )
            )
          )
...
var VideoCell = React.createClass({displayName: "VideoCell",
  getInitialState: function() {
    return {
      showOverlay: false,
    };
  ...
  render: function() {
    if (this.props.eventModel) {
      ...
      switch (this.props.eventModel.webcast[0].type) {
        case "ustream":
          cellEmbed = React.createElement(EmbedUstream, {
            eventModel: this.props.eventModel, 
            vidHeight: this.props.vidHeight, 
            vidWidth: this.props.vidWidth});
          break;
        case "youtube":
          cellEmbed = React.createElement(EmbedYoutube, {
            eventModel: this.props.eventModel, 
            vidHeight: this.props.vidHeight, 
            vidWidth: this.props.vidWidth});
          break;
      ...
      return (
        React.createElement("div", {className: "videoCell", 
          idName: id, 
          onMouseEnter: this.onMouseEnter, 
          onMouseLeave: this.onMouseLeave}, 

          React.createElement(VideoCellOverlay, {eventModel: this.props.eventModel, enabled: this.state.showOverlay}), 
          cellEmbed
        )
      )
    } else {
      return React.createElement("div", {className: "videoCell"})
    }
  }
});

var VideoCellOverlay = React.createClass({displayName: "VideoCellOverlay",
  render: function() {
    var classes = classNames({
      'hidden': !this.props.enabled,
      'panel': true,
      ...
      return (
        React.createElement("div", {className: classes}, 
          React.createElement("div", {className: "panel-heading"}, 
            React.createElement("h3", {className: "panel-title"}, this.props.eventModel.name)
          ), 
          React.createElement("div", {className: "panel-body"})
        )
      )
...
var EmbedYoutube = React.createClass({displayName: "EmbedYoutube",
  render: function() {
...
var EmbedUstream = React.createClass({displayName: "EmbedUstream",
  render: function() {
    ...
    return (
      React.createElement("object", {
        ...
        React.createElement("param", {value: src, name: "movie"}), 
        React.createElement("param", {value: "true", name: "allowFullScreen"}), 
        React.createElement("param", {value: "always", name: "allowScriptAccess"}), 
        React.createElement("param", {value: "transparent", name: "wmode"}), 
        React.createElement("param", {value: "viewcount=true&autoplay=true&brand=embed&", name: "flashvars"}), 
...
var WebcastDropdown = React.createClass({displayName: "WebcastDropdown",
  render: function() {
    var webcastListItems = [];
    for (var i = 0; i < this.props.webcasts.length; i++) {
      webcastListItems.push(React.createElement(WebcastListItem, {webcast: this.props.webcasts[i], onWebcastAdd: this.props.onWebcastAdd}))
    };
    return (
      React.createElement("li", {className: "dropdown"}, 
        React.createElement("a", {href: "#", className: "dropdown-toggle", "data-toggle": "dropdown"}, "Add Webcasts ", React.createElement("b", {className: "caret"})), 
        React.createElement("ul", {className: "dropdown-menu"}, 
          webcastListItems, 
          React.createElement("li", {className: "divider"}), 
          React.createElement(BootstrapNavDropdownListItem, {handleClick: this.props.onWebcastReset}, "Reset Webcasts")
        )
      )
    );
  }
...
var SettingsDropdown = React.createClass({displayName: "SettingsDropdown",
  render: function() {
    return (
      React.createElement("li", {className: "dropdown"}, 
        React.createElement("a", {href: "#", className: "dropdown-toggle", "data-toggle": "dropdown"}, React.createElement("span", {className: "glyphicon glyphicon-cog"})), 
        React.createElement("ul", {className: "dropdown-menu"}, 
          React.createElement(BootstrapNavDropdownListItem, {
            data_toggle: "modal", 
            data_target: "#followingTeamsModal"}, "Follow Teams"), 
          React.createElement("li", {className: "divider"}), 
          React.createElement(BootstrapNavDropdownListItem, null, "Debug Menu"), 
          React.createElement(BootstrapNavDropdownListItem, null, "TODO Show Beeper")
        )
      )
    );
  }
...
var WebcastListItem = React.createClass({displayName: "WebcastListItem",
  handleClick: function() {
    this.props.onWebcastAdd(this.props.webcast);
  },
  render: function() {
    return React.createElement(BootstrapNavDropdownListItem, {handleClick: this.handleClick}, this.props.webcast.name)
  },
})

var BootstrapNavDropdownListItem = React.createClass({displayName: "BootstrapNavDropdownListItem",
  getDefaultProps: function() {
    return {
      a: '#'
    };
  ...
  render: function() {
    return (
      React.createElement("li", {"data-toggle": this.props.data_toggle, "data-target": this.props.data_target}, React.createElement("a", {href: this.props.a, onClick: this.handleClick}, this.props.children))
    )
  },
})

var FollowingTeamListItems = React.createClass({displayName: "FollowingTeamListItems",
  ...
  render: function() {
    return (
      React.createElement("li", null, 
        this.props.team, 
        React.createElement("a", {href: "#", onClick: this.unfollowTeam}, "×")
      )
    );
  }
})

var FollowingTeamsModal = React.createClass({displayName: "FollowingTeamsModal",
  followTeam: function() {
  ...
  render: function() {
    ...
    for (var index in this.props.followingTeams) {
      followingTeamListItems.push(
        React.createElement(FollowingTeamListItems, {
          team: this.props.followingTeams[index], 
          onUnfollowTeam: this.props.onUnfollowTeam})
        );
    };
    return (
      React.createElement("div", {className: "modal fade", id: "followingTeamsModal", tabindex: "-1", role: "dialog", "aria-labelledby": "#followingTeamsModal", "aria-hidden": "true"}, 
        React.createElement("div", {className: "modal-dialog"}, 
          React.createElement("div", {className: "modal-content"}, 
            React.createElement("div", {className: "modal-header"}, 
              ...
              React.createElement("h4", {className: "modal-title", id: "followingTeamsModalLabel"}, "Following Teams")
            ), 
            React.createElement("div", {className: "modal-body"}, 
              React.createElement("p", null, "You can follow teams to get alerts about them."), 
              React.createElement("div", {className: "input-group"}, 
                React.createElement("input", {className: "form-control", type: "text", placeholder: "Team Number"}), 
                React.createElement("span", {className: "input-group-btn"}, 
                  React.createElement("a", {onClick: this.followTeam, href: "#", className: "btn btn-primary"}, React.createElement("span", {className: "glyphicon glyphicon-plus-sign"}))
                )
              ), 
              React.createElement("hr", null), 
              React.createElement("h4", null, "Following"), 
              React.createElement("ul", null, followingTeamListItems)
            ), 
            React.createElement("div", {className: "modal-footer"}, 
              React.createElement("button", {type: "button", className: "btn btn-primary", "data-dismiss": "modal"}, "Done")
            )
          )
        )
      )
...
ReactDOM.render(
  React.createElement(GamedayFrame, {webcastData: webcastData, pollInterval: 20000}),
  document.getElementById('content')
);

},{"classnames":1,"react":166,"react-dom":29}]},{},[167]);
