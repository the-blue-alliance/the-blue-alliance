...
from controllers.datafeed_controller import EventListEnqueue, EventTeamsEnqueue
from controllers.datafeed_controller import EventListGet, EventTeamsGet
...
app = webapp2.WSGIApplication([('/tasks/enqueue/csv_backup_events', TbaCSVBackupEventsEnqueue),
                               ...
                               ('/tasks/enqueue/eventteams/(.*)', EventTeamsEnqueue),
                               ...
                               ('/tasks/get/eventteams/(.*)', EventTeamsGet),
