...
from _pytest.compat import (
    ATTRS_EQ_FIELD as ATTRS_EQ_FIELD,
...
class Traceback(List[TracebackEntry]):
    def __init__(
        ...
        excinfo: Optional[ReferenceType[ExceptionInfo]] = ...,
    ) -> None: ...
    def cut(
        self,
        path: Any = ...,
...
class FormattedExcinfo:
    ...
    def get_source(
        ...
        source: Source,
        line_index: int = ...,
        excinfo: Optional[ExceptionInfo] = ...,
        short: bool = ...,
    ) -> List[str]: ...
    def get_exconly(
        self, excinfo: ExceptionInfo, indent: int = ..., markall: bool = ...
    ) -> List[str]: ...
    def repr_locals(self, locals: Dict[str, object]) -> Optional[ReprLocals]: ...
    def repr_traceback_entry(
        self, entry: TracebackEntry, excinfo: Optional[ExceptionInfo] = ...
    ) -> ReprEntry: ...
