from google.cloud.ndb import _options, Future, Model
...
class Query:
    ...
    projection: Any = ...
    distinct_on: Any = ...
    def __init__(self, kind: Optional[Any] = ..., filters: Optional[Any] = ..., ancestor: Optional[Any] = ..., order_by: Optional[Any] = ..., orders: Optional[Any] = ..., project: Optional[Any] = ..., app: Optional[Any] = ..., namespace: Optional[Any] = ..., projection: Optional[Any] = ..., distinct_on: Optional[Any] = ..., group_by: Optional[Any] = ..., default_options: Optional[Any] = ...) -> None: ...
    @property
    ...
    def fetch(self, limit: Optional[Any] = ..., **kwargs: Any) -> List[Model]: ...
    def fetch_async(self, limit: Optional[Any] = ..., **kwargs: Any) -> "TypedFuture[List[Model]]": ...
    ...
    def get_async(self, **kwargs: Any) -> "TypedFuture[Model]": ...
