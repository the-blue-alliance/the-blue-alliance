...
class Client(google_client.ClientWithProject):
    ...
    def context(self, namespace: Any = ..., cache_policy: Optional[Any] = ..., global_cache: Optional[Any] = ..., global_cache_policy: Optional[Any] = ..., global_cache_timeout_policy: Optional[Any] = ..., legacy_data: bool = ...) -> None: ...
