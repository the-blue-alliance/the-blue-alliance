...
from google.appengine.ext.ndb import context, Model
...
class Query:
    ...
    def fetch(self, limit: Any | None = ..., **q_options) -> List[Model]: ...
    def fetch_async(self, limit: Any | None = ..., **q_options) -> "TypedFuture[List[Model]]": ...
    def get(self, **q_options) -> Model: ...
    def get_async(self, **q_options) -> "TypedFuture[Model]": ...
