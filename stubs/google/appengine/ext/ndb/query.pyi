...
from google.appengine.ext.ndb import context, Key, Model
from typing import Any, Generic, Literal, List, Optional, overload, TypeVar
...
class Query(Generic[T]):
    ...
    @overload
    def fetch_async(self, limit: Optional[int] = None, **q_options) -> "TypedFuture[List[T]]": ...

    @overload
    def fetch_async(self, keys_ony: Literal[True], **q_options) -> "TypedFuture[List[Key]]": ...

    def get(self, **q_options) -> T: ...
    def get_async(self, **q_options) -> "TypedFuture[T]": ...
