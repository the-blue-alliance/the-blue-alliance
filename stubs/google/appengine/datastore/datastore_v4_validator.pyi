from google.appengine.datastore import datastore_pbs as datastore_pbs, datastore_v4_pb2 as datastore_v4_pb2
...
class _EntityValidator:
    ...
    def validate_dataset_id(self, constraint, dataset_id) -> None: ...
...
class _ServiceValidator:
    def __init__(self, entity_validator, query_validator) -> None: ...
    ...
    def validate_continue_query_req(self, req) -> None: ...
    def validate_lookup_req(self, req) -> None: ...
    def validate_allocate_ids_req(self, req) -> None: ...
    def validate_read_options(self, read_options) -> None: ...
