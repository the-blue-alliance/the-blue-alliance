...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(r'/api/v3/team/<team_key:>/events/<year:([0-9]+)>/<model_type:(simple|keys)>',
        ApiStatusController, methods=['GET', 'OPTIONS']),
    webapp2.Route(r'/api/v3/team/<team_key:>/event/<event_key:>/matches/<match_model_type:>',
        ApiStatusController, methods=['GET', 'OPTIONS']),
    webapp2.Route(r'/api/v3/team/<team_key:>/event/<event_key:>/matches/<match_model_type:>/<model_type:(simple|keys)>',
        ApiStatusController, methods=['GET', 'OPTIONS']),
