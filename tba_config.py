...
DEBUG = os.environ.get('SERVER_SOFTWARE') is not None and os.getenv(
    'APPLICATION_ID') != 's~tbatv-prod-hrd'
DEBUG = DEBUG or os.getenv('IS_TBA_TEST') is not None or os.getenv(
    'TRAVIS') is not None
...
if DEBUG:
    CONFIG = {
        ...
        False,
        "firebase-url":
        "https://thebluealliance-dev.firebaseio.com/{}.json?print=silent&auth={}",
        "firebase-push":
        False,
        "use-compiled-templates":
        False,
        "save-frc-api-response":
        False,
        "update-webcast-online-status":
        False,
    }
else:
    CONFIG = {
        ...
        True,
        "firebase-url":
        "https://tbatv-prod-hrd.firebaseio.com/{}.json?print=silent&auth={}",
        "firebase-push":
        True,
        "use-compiled-templates":
        True,
