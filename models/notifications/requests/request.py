class Request(object):
    ...
    def defer_track_notification(self, num_keys):
        ...
        deferred.defer(self._track_notification, type(self.notification)._type(), num_keys, _queue="api-track-call", _url='/_ah/queue/deferred_notification_track_send')

    def _track_notification(self, notification_type_enum, num_keys):
        """
