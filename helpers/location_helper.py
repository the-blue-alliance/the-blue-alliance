...
class LocationHelper(object):
    ...
    def get_similarity(cls, a, b):
        """
        Returns max(similarity between two strings ignoring case and order,
    ...
    def compute_team_location_score(cls, team, query, location_info):
        ...
        if team.country:
            ...
            score += partial if partial > SCORE_THRESHOLD else 0
        if team.state_prov:
            partial = max(
        ...
        score += partial if partial < NAME_SCORE_THRESHOLD else 1
