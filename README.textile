...
Paver is an easy way automate repetitive tasks. These tasks are stored in pavement.py. Download and install paver from http://pypi.python.org/pypi/Paver/ or use easy_install to install it.
...
python run_tests.py /usr/local/bin tests/
