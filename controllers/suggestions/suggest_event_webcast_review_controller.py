...
class SuggestEventWebcastReviewController(SuggestionsReviewBaseController):
    ...
    def get(self):
        ...
        for suggestion in suggestions:
            ...
            suggestions_by_event_key.setdefault(suggestion.target_key,
                                                []).append(suggestion)
        ...
        path = os.path.join(
            ...
            '../../templates/suggest_event_webcast_review_list.html')
    ...
    def post(self):
        ...
        if self.request.get("verdict") == "accept":
            ...
            suggestion_key = int(
                suggestion_key) if suggestion_key.isdigit() else suggestion_key
            ...
            suggestion_keys = [
                int(suggestion_key)
                if suggestion_key.isdigit() else suggestion_key
