    ...
    def get(self):
        ...
        for event, teams in past_events_by_event.itervalues():
            ...
            for team in teams:
                ...
                teams_and_statuses.append(
                    (team, event_team.status,
                     status_str, AwardHelper.organizeAwards(
        ...
        for event, teams in live_events_by_event.itervalues():
            ...
            for team in teams:
                ...
                teams_and_statuses.append((team, event_team.status,
                                           status_str))
            teams_and_statuses.sort(key=lambda x: x[0].team_number)
        ...
        path = os.path.join(
            os.path.dirname(__file__), '../templates/mytba_live.html')
