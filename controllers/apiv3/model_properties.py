simple_event_properties = [
    'key', 'name', 'year', 'event_code', 'event_type', 'district',
...
def filter_event_properties(events, model_type):
    ...
    if model_type == 'simple':
        return [{key: event[key]
                 for key in simple_event_properties} for event in events]
...
def filter_team_properties(teams, model_type):
    ...
    if model_type == 'simple':
        return [{key: team[key]
                 for key in simple_team_properties} for team in teams]
    elif model_type == 'keys':
...
def filter_match_properties(matches, model_type):
    ...
    if model_type == 'simple':
        return [{key: match[key]
                 for key in simple_match_properties} for match in matches]
    elif model_type == 'keys':
