...
app = webapp2.WSGIApplication([
      ...
      RedirectRoute(r'/team/<team_number:[0-9]+[B-Z]?>', TeamCanonical, 'team-canonical', strict_slash=True),
      RedirectRoute(r'/team/<team_number:[0-9]+[B-Z]?>/<year:[0-9]+>', TeamDetail, 'team-detail', strict_slash=True),
      RedirectRoute(r'/team/<team_number:[0-9]+[B-Z]?>/history', TeamHistory, 'team-history', strict_slash=True),
