...
from controllers.ajax_controller import AccountFavoritesHandler
...
app = webapp2.WSGIApplication([
      ...
      RedirectRoute(r'/_/account/favorites', AccountFavoritesHandler, 'ajax-account-favorites', strict_slash=True),
