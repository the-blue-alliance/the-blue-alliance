...
app = webapp2.WSGIApplication(
    [
        ...
        ('/admin/event/add_alliance_selections/(.*)',
         AdminEventAddAllianceSelections),
        ...
        ('/admin/migration/create_event_details',
         AdminMigrationCreateEventDetails),
        ('/admin/migration/migrate_rankings/([0-9]*)', AdminMigrationRankings),
        ('/admin/migration/add_surrogates/([0-9]*)',
         AdminMigrationAddSurrogates),
