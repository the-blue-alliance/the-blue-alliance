...
SCRIPTS_MAIN = ['src/backend/web/static/jwplayer/jwplayer.js',
...
SCRIPTS_FIREBASE_SERVICEWORKER = ['src/backend/web/static/javascript/tba_js/tba_keys.js',
                                  'src/backend/web/static/javascript/tba_js/firebase_messaging_serviceworker.js',
                                  ]

SCRIPTS_GAMEDAY = SCRIPTS_MAIN + ['src/backend/web/static/javascript/tba_js/gameday.js',
...
SCRIPTS_EVENTWIZARD = ['src/backend/web/static/javascript/tba_js/eventwizard_apiwrite.js',
                       'src/backend/web/static/javascript/tba_js/eventwizard.js']

STYLESHEETS_MAIN = ['src/backend/web/static/css/precompiled_css/jquery.fancybox.css',
...
STYLESHEETS_GAMEDAY = ['src/backend/web/static/css/precompiled_css/jquery.fancybox.css',
                       'src/backend/web/static/css/precompiled_css/tablesorter.css',
