...
): RequestResult<ListFavoritesResponses, unknown, ThrowOnError> =>
...
): RequestResult<SetModelPreferencesResponses, unknown, ThrowOnError> =>
  (options.client ?? client).post<
    SetModelPreferencesResponses,
    unknown,
    ThrowOnError
...
): RequestResult<SuggestTeamMediaResponses, unknown, ThrowOnError> =>
  (options.client ?? client).post<
    SuggestTeamMediaResponses,
    unknown,
    ThrowOnError
...
): RequestResult<ListSubscriptionsResponses, unknown, ThrowOnError> =>
  (options?.client ?? client).post<
    ListSubscriptionsResponses,
    unknown,
    ThrowOnError
