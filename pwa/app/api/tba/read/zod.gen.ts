 ...
 */
export const zCompLevel = z.enum([
    'qm',
    'ef',
    'qf',
    'sf',
...
export const zTowerRobot2026 = z.enum([
    'Level1',
    'Level2',
    'Level3',
    'None'
...
export const zEndgameRobot2020 = z.enum([
    'Hang',
    'None',
    'Park'
]);
 ...
 */
export const zEventCoprs = z.record(z.string(), z.record(z.string(), z.number()));
...
export const zEventDistrictPoints = z.object({
    ...
    tiebreakers: z.optional(z.record(z.string(), z.object({
        highest_qual_scores: z.optional(z.array(z.int())),
        qual_wins: z.optional(z.int())
    })))
});

export const zEventRegionalChampsPoolPoints = z.object({
    points: z.record(z.string(), z.object({
        total: z.int(),
        alliance_points: z.int(),
        elim_points: z.int(),
...
export const zMatchScoreBreakdown2015Alliance = z.object({
    auto: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    auto_points: z.optional(z.union([
        z.int(),
        z.null()
    ])),
    ...
    foul: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    foul_points: z.optional(z.union([
        z.int(),
        z.null()
    ])),
...
export const zMatchScoreBreakdown2018Alliance = z.object({
    ...
    vaultPoints: z.int(),
    tba_gameData: z.optional(z.enum([
        '',
        'LLL',
        'LRL',
        'RLR',
...
export const zMatchScoreBreakdown2023Alliance = z.object({
    ...
    autoCommunity: z.optional(z.object({
        B: z.array(z.enum([
            'None',
            'Cone',
            'Cube'
    ...
    teleopCommunity: z.optional(z.object({
        B: z.array(z.enum([
            'None',
            'Cone',
            'Cube'
...
export const zPreMatchBay2019 = z.enum([
    'Cargo',
    'Panel',
    'Unknown'
]);
...
export const zRegionalRanking = z.object({
    ...
    point_total: z.int(),
    event_points: z.optional(z.array(z.object({
        total: z.int(),
        alliance_points: z.int(),
        elim_points: z.int(),
        award_points: z.int(),
...
export const zRobotAuto2017 = z.enum([
    'Mobility',
    'None',
    'Unknown'
]);
...
export const zMatchScoreBreakdown2017Alliance = z.object({
    ...
    tba_rpEarned: z.optional(z.union([
        z.int(),
        z.null()
    ])),
    techFoulCount: z.optional(z.int()),
...
export const zDistrictInsight = z.object({
    district_data: z.object({
        ...
        district_wide_data: z.union([
            zDistrictInsightRegionData,
            z.null()
        ])
    }),
    team_data: z.union([
...
export const zEliminationAlliance = z.object({
    ...
    status: z.optional(z.object({
        playoff_average: z.optional(z.union([
            z.number(),
            z.null()
        ])),
...
export const zTeamEventStatusPlayoff = z.union([
    ...
    z.object({
        ...
        current_level_record: z.optional(z.union([
            zWltRecord,
            z.null()
        ])),
        record: z.optional(z.union([
            zWltRecord,
            z.null()
        ])),
...
export const zTeamEventStatusRank = z.object({
    ...
    ranking: z.optional(z.union([
        z.object({
            ...
            qual_average: z.optional(z.union([
                z.number(),
                z.null()
            ])),
            sort_orders: z.optional(z.union([
                z.array(z.number()),
                z.null()
            ])),
            record: z.optional(z.union([
    ...
    sort_order_info: z.optional(z.union([
        z.array(z.object({
...
export const zTeamEventStatus = z.object({
    qual: z.optional(z.union([
        zTeamEventStatusRank,
        z.null()
    ])),
    alliance: z.optional(z.union([
        zTeamEventStatusAlliance,
        z.null()
    ])),
    playoff: z.optional(z.union([
        zTeamEventStatusPlayoff,
        z.null()
    ])),
    alliance_status_str: z.optional(z.string()),
    playoff_status_str: z.optional(z.string()),
    overall_status_str: z.optional(z.string()),
    next_match_key: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    last_match_key: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    pit_location: z.optional(z.union([
        z.string(),
        z.null()
    ]))
});
...
export const zWebcast = z.object({
    ...
    stream_title: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    viewer_count: z.optional(z.union([
        z.int(),
        z.null()
    ]))
});
...
export const zEvent = z.object({
    ...
    first_event_id: z.union([
        z.string(),
        z.null()
    ]),
    first_event_code: z.union([
        z.string(),
        z.null()
    ]),
    webcasts: z.array(zWebcast),
    division_keys: z.array(z.string()),
    parent_event_key: z.union([
        z.string(),
        z.null()
    ]),
    playoff_type: z.union([
 ...
 * Successful response
 */
export const zGetDistrictDcmpHistoryResponse = z.array(z.object({
...
export const zGetEventAdvancementPointsResponse = z.union([
    zEventRegionalChampsPoolPoints,
    z.null()
]);
 ...
 * Successful response
 */
export const zGetEventCoprsResponse = z.union([
    zEventCoprs,
    z.null()
]);
 ...
 * Successful response
 */
export const zGetEventInsightsResponse = z.union([
    zEventInsights,
    z.null()
]);
 ...
 * Successful response
 */
export const zGetEventOprsResponse = z.union([
    zEventOprs,
    z.null()
]);
 ...
 * Successful response
 */
export const zGetEventRankingsResponse = z.union([
    zEventRanking,
    z.null()
]);
 ...
 */
export const zGetEventTeamsStatusesResponse = z.record(z.string(), z.union([
    zTeamEventStatus,
    z.null()
]));
 ...
 * Successful response
 */
export const zGetInsightsLeaderboardsYearResponse = z.array(zLeaderboardInsight);
 ...
 * Successful response
 */
export const zGetMatchTimeseriesResponse = z.array(z.record(z.string(), z.unknown()));
 ...
 * A key-value pair of `Team_Event_Status` objects with the event key as the key.
 */
export const zGetTeamEventsStatusesByYearResponse = z.record(z.string(), z.union([
    zTeamEventStatus,
    z.null()
]));
