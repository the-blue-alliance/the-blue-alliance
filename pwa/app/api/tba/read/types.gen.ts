...
export type Event = {
  ...
  /**
   * Map of temporary "off-season demo" team numbers to pre-rookie and B teams. Both keys and values are team keys in the format 'frc####'. Key is the old team key, value is the new team key.
   */
  remap_teams: {
    [key: string]: string;
  } | null;
