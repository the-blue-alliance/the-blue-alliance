...
- **Auto-sorts imports** - with newlines between groups
- **Tailwind class sorting** - via `sortTailwindcss` in `.oxfmtrc.json`
- **Package.json sorting** - via `sortPackageJson` in `.oxfmtrc.json`
