...
EventManualAlliances.propTypes = {
  allianceSize: PropTypes.number.isRequired,
  alliances: PropTypes.arrayOf(
    PropTypes.shape({
      captain: PropTypes.string,
      pick1: PropTypes.string,
      pick2: PropTypes.string,
      pick3: PropTypes.string,
    })
  ).isRequired,
  uploading: PropTypes.bool.isRequired,
  selectedEvent: PropTypes.string,
  onAllianceSizeChange: PropTypes.func.isRequired,
