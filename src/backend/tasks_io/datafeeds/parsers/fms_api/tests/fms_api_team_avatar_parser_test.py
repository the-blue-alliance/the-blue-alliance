...
def test_parse_avatars_only_media(test_data_importer, ndb_client: ndb.Client):
...
def test_parse_avatars_only_delete(test_data_importer, ndb_client: ndb.Client):
...
def test_parse_avatars(test_data_importer, ndb_client: ndb.Client):
