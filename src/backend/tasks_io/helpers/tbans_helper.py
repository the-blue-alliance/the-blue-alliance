...
class TBANSHelper:
    ...
    def _ping_client(client):
        ...
        if client_type in FCM_CLIENTS:
            ...
            from backend.tasks_io.models.notification_requests import (
                FCMRequest,
            )
    ...
    def _send_fcm(
        ...
        from backend.tasks_io.models.notification_requests import FCMRequest
        from backend.tasks_io.models.notification_requests.fcm_request import (
            MAXIMUM_TOKENS,
        )
