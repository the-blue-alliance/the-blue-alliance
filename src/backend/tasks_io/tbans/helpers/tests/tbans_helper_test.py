...
from backend.tasks_io.tbans.helpers.tbans_helper import _firebase_app, TBANSHelper
from backend.tasks_io.tbans.models.notifications.alliance_selection import (
    AllianceSelectionNotification,
)
from backend.tasks_io.tbans.models.notifications.awards import AwardsNotification
from backend.tasks_io.tbans.models.notifications.broadcast import BroadcastNotification
from backend.tasks_io.tbans.models.notifications.event_level import (
    EventLevelNotification,
)
from backend.tasks_io.tbans.models.notifications.event_schedule import (
    EventScheduleNotification,
)
from backend.tasks_io.tbans.models.notifications.match_score import (
    MatchScoreNotification,
)
from backend.tasks_io.tbans.models.notifications.match_upcoming import (
    MatchUpcomingNotification,
)
from backend.tasks_io.tbans.models.notifications.match_video import (
    MatchVideoNotification,
)
from backend.tasks_io.tbans.models.notifications.requests.fcm_request import FCMRequest
from backend.tasks_io.tbans.models.notifications.requests.webhook_request import (
    WebhookRequest,
)
from backend.tasks_io.tbans.tests.mocks.notifications.mock_notification import (
    MockNotification,
)
...
class TestTBANSHelper(unittest.TestCase):
    ...
    def test_match_score_match_upcoming(self):
        ...
        with patch.object(
            ...
            self.assertEqual(
                schedule_upcoming_match.call_args[0][0], next_matches.pop()
            )
    ...
    def test_send_fcm_maximum_backoff(self):
        for i in range(0, 6):
            exit_code = TBANSHelper._send_fcm(
                [], MockNotification(), backoff_iteration=i
            )
            assert exit_code == 0
    ...
    def test_send_fcm_filter_fcm_clients(self):
        ...
        with patch(
            "backend.tasks_io.tbans.models.notifications.requests.fcm_request.FCMRequest",
            autospec=True,
        ) as mock_init:
    ...
    def test_send_fcm_batch(self):
        ...
        batch_response = messaging.BatchResponse([])
        with patch(
            "backend.tasks_io.tbans.models.notifications.requests.fcm_request.MAXIMUM_TOKENS",
            2,
    ...
    def test_send_webhook_filter_webhook_clients(self):
        ...
        with patch(
            "backend.tasks_io.tbans.models.notifications.requests.webhook_request.WebhookRequest",
            autospec=True,
        ) as mock_init:
