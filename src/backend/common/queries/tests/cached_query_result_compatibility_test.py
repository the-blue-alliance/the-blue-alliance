...

    ...
    expected_result = [
        Media(
            ...
            private_details_json=None,
            references=[
                ndb.Key("Team", "frc4829", project="tbatv-prod-hrd")
            ],
