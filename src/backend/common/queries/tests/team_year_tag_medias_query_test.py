...
from backend.common.queries.media_query import TeamYearTagMediasQuery


def test_no_data() -> None:
    medias = TeamYearTagMediasQuery(
        team_key="frc254", year=2019, media_tag=MediaTag.CHAIRMANS_VIDEO
    ).fetch()
    assert medias == []
