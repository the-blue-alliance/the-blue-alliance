...
class InsightV2YearQuery(CachedDatabaseQuery[List[InsightV2], List[InsightV2Dict]]):
    """All InsightV2 entities for a year, across all categories."""
    ...
    def _query_async(self, year: Year) -> Generator[Any, Any, List[InsightV2]]:
        insights = yield InsightV2.query(InsightV2.year == year).fetch_async()
        return insights
...
class InsightV2YearCategoryQuery(
    ...
    """All InsightV2 entities for a year filtered by category."""
