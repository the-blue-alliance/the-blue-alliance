...
#   filename:  frc-api-combined.json
...
class RegistrationTeamModelV2(TypedDict):
    teamNumber: int
...
class SeasonEventModelV3(TypedDict):
...
class WebcastDetailModelExtV33(TypedDict):
    link: str | None
    provider: str | None
    channel: str | None
    slug: str | None
    isFirstWebcastUnit: bool
    date: str | None
...
class RegistrationModelV2(TypedDict):
    Registrations: list[RegistrationTeamModelV2] | None
    registrationCountTotal: int
    registrationCountPage: int
    pageCurrent: int
    pageTotal: int
...
class SeasonEventListModelV3(TypedDict):
    Events: list[SeasonEventModelV3] | None
    eventCount: int
...
class SeasonEventModelV33(TypedDict):
    webcasts: list[WebcastDetailModelExtV33] | None
    allianceSelectionType: int
    backupSubstitutionType: int
    playoffBracketType: int
    allianceCount: str | None
...
class SeasonEventListModelV33(TypedDict):
    Events: list[SeasonEventModelV33] | None
    eventCount: int
