...
def test_default_sitevar():
    ...
    assert default_sitevar.description == "Google Analytics ID and API secret for logging API requests"
...
def test_both_fields():
    ...
    GoogleAnalyticsID.put(ContentType(GOOGLE_ANALYTICS_ID=test_id, API_SECRET=test_secret))
