...
app = webapp2.WSGIApplication(
    [('/backend-tasks-b2/math/enqueue/overallinsights/(.*)',
      OverallInsightsEnqueue),
     ('/backend-tasks-b2/math/do/overallinsights/(.*)', OverallInsightsDo),
     ('/backend-tasks-b2/math/enqueue/insights/(.*)/([0-9]*)',
      YearInsightsEnqueue),
     ...
     ('/backend-tasks-b2/enqueue/rebuild_districts/([0-9]+)',
      AdminCreateDistrictsEnqueue),
     ('/backend-tasks-b2/do/rebuild_districts/([0-9]+)',
      AdminCreateDistrictsDo)],
