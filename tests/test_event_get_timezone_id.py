...
class TestEventGetTimezoneId(unittest2.TestCase):
    ...
    def test_2012ct_no_location(self):
        ...
        event['location'] = None
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], None)
    ...
    def test_2012ct(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (41.76371109999999, -72.6850932))
    ...
    def test_2013flbr(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (26.1224386, -80.13731740000001))
        self.assertEqual(LocationHelper.get_timezone_id(event['location']), 'America/New_York')
    ...
    def test_2013casj(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (37.3382082, -121.8863286))
    ...
    def test_2005is(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (32.7940463, 34.989571))
    ...
    def test_2005or(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (45.5230622, -122.6764816))
        self.assertEqual(LocationHelper.get_timezone_id(event['location']), 'America/Los_Angeles')
    ...
    def test_1997il(self):
        ...
        self.assertEqual(LocationHelper.get_lat_lng(event['location'])[0], (41.8781136, -87.6297982))
