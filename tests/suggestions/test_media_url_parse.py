...
class TestMediaUrlParser(unittest2.TestCase):
    ...
    def test_youtube_parse(self):
        ...
        self.assertEqual(yt_from_playlist['media_type_enum'],
    ...
    def test_cdphotothread_parse(self):
        cd = MediaParser.partial_media_dict_from_url(
            "http://www.chiefdelphi.com/media/photos/41999")
        ...
        self.assertEqual(details['image_partial'],
                         "a88/a880fa0d65c6b49ddb93323bc7d2e901_l.jpg")
    ...
    def test_imgur_parse(self):
        ...
        self.assertEqual(
            MediaParser.partial_media_dict_from_url("http://imgur.com/r/aww"),
            None)
        self.assertEqual(
            MediaParser.partial_media_dict_from_url(
                "http://imgur.com/a/album"), None)
    ...
    def test_fb_profile_parse(self):
        ...
        self.assertEqual(result['site_name'],
                         MediaType.type_names[MediaType.FACEBOOK_PROFILE])
        self.assertEqual(result['profile_url'],
                         'https://www.facebook.com/theuberbots')
    ...
    def test_twitter_profile_parse(self):
        ...
        self.assertEqual(result['site_name'],
                         MediaType.type_names[MediaType.TWITTER_PROFILE])
    ...
    def test_github_profile_parse(self):
        ...
        self.assertEqual(result['site_name'],
                         MediaType.type_names[MediaType.GITHUB_PROFILE])
    ...
    def test_instagram_profile_parse(self):
        ...
        self.assertEqual(result['media_type_enum'],
                         MediaType.INSTAGRAM_PROFILE)
        self.assertEqual(result['is_social'], True)
        self.assertEqual(result['foreign_key'], '4hteamneutrino')
        self.assertEqual(result['site_name'],
                         MediaType.type_names[MediaType.INSTAGRAM_PROFILE])
        self.assertEqual(result['profile_url'],
                         'https://www.instagram.com/4hteamneutrino')
    ...
    def test_periscope_profile_parse(self):
        ...
        self.assertEqual(result['site_name'],
                         MediaType.type_names[MediaType.PERISCOPE_PROFILE])
        self.assertEqual(result['profile_url'],
                         'https://www.periscope.tv/evolution2626')
    ...
    def test_grabcad_link(self):
        ...
        self.assertEqual(
            details['model_image'],
            'https://d2t1xqejof9utc.cloudfront.net/screenshots/pics/96268d5c5e6c1b7fe8892f713813bb40/card.jpg'
        )
...
class TestWebcastUrlParser(unittest2.TestCase):
    ...
    def testUnknownUrl(self):
        bad = WebcastParser.webcast_dict_from_url(
