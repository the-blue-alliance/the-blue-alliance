...
class TestUsfirstEventOffseasonListParser(unittest2.TestCase):
    def test_parse_2013(self):
        ...
        # can't get the timezones working just now. -gregmarra 20130921
        ...
        # self.assertEqual(events[0]["start_date"], datetime.datetime(2013, 9, 13, 8, 0, 0))
        # self.assertEqual(events[0]["end_date"], datetime.datetime(2013, 9, 14, 16, 0, 0))
