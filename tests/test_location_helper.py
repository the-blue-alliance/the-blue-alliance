...
class TestLocationHelper(unittest2.TestCase):
    ...
    def test_team_location(self):
        ...
        LocationHelper.update_team_location(team)
        self.assertEqual(team.normalized_location.name, u'Haydar Ak\u0131n Mesleki ve Teknik Anadolu Lisesi')
        self.assertEqual(team.normalized_location.formatted_address, u'Mustafa Kemal Pa\u015fa, Hilal Sk. No:69, 34320 Avc\u0131lar/\u0130stanbul, Turkey')
        self.assertEqual(team.normalized_location.street_number, '69')
        self.assertEqual(team.normalized_location.street, u'Hilal Sokak')
        self.assertEqual(team.normalized_location.city, u'\u0130stanbul')
        self.assertEqual(team.normalized_location.state_prov, u'\u0130stanbul')
        self.assertEqual(team.normalized_location.state_prov_short, u'\u0130stanbul')
        self.assertEqual(team.normalized_location.country, 'Turkey')
        self.assertEqual(team.normalized_location.country_short, 'TR')
        self.assertEqual(team.normalized_location.postal_code, u'34320')
        self.assertEqual(team.normalized_location.lat_lng, ndb.GeoPt(40.99737940000001, 28.703283))
