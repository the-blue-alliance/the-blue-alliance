...
class TestApiTrustedController(unittest2.TestCase):
    ...
    def test_auth(self):
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_1',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'badTestAuthId',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
        self.assertEqual(response.status_code, 401)
        self.assertTrue('Error' in response.json)
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_2',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
        self.assertEqual(response.status_code, 401)
        self.assertTrue('Error' in response.json)
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_6',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
        self.assertEqual(response.status_code, 401)
        self.assertTrue('Error' in response.json)
    ...
    def test_admin_auth(self):
        ...
        response = self.testapp.post(
            request_path, request_body, expect_errors=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_killswitch(self):
        ...
        trusted_sitevar = Sitevar(
            id='trustedapi', values_json=json.dumps({
                3: False,
            }))
        trusted_sitevar.put()
    ...
    def test_alliance_selections_update(self):
        ...
        ], ['frc2035', 'frc192', 'frc4990'], ['frc1323', 'frc846', 'frc2135'],
                     ['frc2144', 'frc1388',
                      'frc668'], ['frc1280', 'frc604',
                                  'frc100'], ['frc114', 'frc852', 'frc841'],
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_3',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
    ...
    def test_empty_alliance_selections_update(self):
        ...
        alliances = [['frc971', 'frc254',
                      'frc1662'], ['frc1678', 'frc368', 'frc4171'],
    ...
    def test_awards_update(self):
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_4',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
    ...
    def test_eventteams_update(self):
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_0',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
    ...
    def test_match_videos_add(self):
        ...
        response = self.testapp.post(
            request_path,
            request_body,
            headers={'X-TBA-Auth-Id': 'tEsT_id_5',
                     'X-TBA-Auth-Sig': sig},
            expect_errors=True)
        ...
        self.assertEqual(
            set(Match.get_by_id('2014casj_qm1').youtube_videos),
            {'abcdef', 'aFZy8iibMD0'})
        self.assertEqual(
    ...
    def test_event_media_add(self):
        ...
        media_key = Media.render_key_name(MediaType.YOUTUBE_VIDEO,
                                          'aFZy8iibMD0')
