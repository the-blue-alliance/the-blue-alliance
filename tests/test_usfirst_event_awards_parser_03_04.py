...
class TestUsfirstEventAwardsParser_03_04(unittest2.TestCase):
    def test_parse_regional_2004(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2004sj.html',
                  'r') as f:
        ...
        individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': 115,
                'awardee': u"Ted Shinta"
            }]
        }
        self.assertTrue(individual_award in awards)

    def test_parse_regional_2003(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2003sj.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser_03_04.parse(f.read())
        ...
        individual_award = {
            'name_str':
            "Silicon Valley Regional Volunteer of the Year",
            'award_type_enum':
            AwardType.VOLUNTEER,
            'team_number_list': [],
            'recipient_json_list': [{
                'team_number': None,
                'awardee': u"Ken Krieger"
            }, {
                'team_number': None,
                'awardee': u"Ken Leung"
            }]
    ...
    def test_parse_cmp_2003(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2003cmp.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser_03_04.parse(f.read())
