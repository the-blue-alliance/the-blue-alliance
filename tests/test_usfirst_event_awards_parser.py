...
class TestUsfirstEventAwardsParser(unittest2.TestCase):
    def test_parse_regional_2007(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2007sj.html',
                  'r') as f:
        ...
        individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': None,
                'awardee': u"Yang Xie \u2013 Team 846"
            }],
        }
        self.assertTrue(individual_award in awards)

    def test_parse_regional_2010(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2010sac.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        team_and_individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': 604,
                'awardee': u"Helen Arrington"
            }],
        }
        self.assertTrue(team_and_individual_award in awards)

    def test_parse_regional_2012(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2012sj.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
    ...
    def test_parse_district_championship_2009(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2009gl.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': None,
                'awardee': u"Jennifer Harvey of Team 503"
            }],
        }
        self.assertTrue(individual_award in awards)

    def test_parse_district_championship_2012(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2012gl.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        multi_team_and_individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': 3538,
                'awardee': u"Jaris Dingman"
            }, {
                'team_number': 548,
                'awardee': u"Claire Goolsby"
            }, {
                'team_number': 2834,
                'awardee': u"Ryan Hoyt"
            }, {
                'team_number': 33,
                'awardee': u"Andrew Palardy"
            }, {
                'team_number': 862,
                'awardee': u"Ian Pudney"
            }, {
                'team_number': 1684,
                'awardee': u"Matthew Wagner"
            }],
        }
    ...
    def test_parse_championship_divison_2007(self):
        with open(
                'test_data/usfirst_html/usfirst_event_awards_2007galileo.html',
                'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
    ...
    def test_parse_championship_2007(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2007cmp.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        individual_award = {
            'name_str':
            "Championship - FRC Outstanding Volunteer Award",
            'award_type_enum':
            AwardType.VOLUNTEER,
            'team_number_list': [],
            'recipient_json_list': [{
                'team_number': None,
                'awardee': u"Mark Koors"
            }],
        }
        self.assertTrue(individual_award in awards)
    ...
    def test_parse_championship_divison_2012(self):
        with open(
                'test_data/usfirst_html/usfirst_event_awards_2012galileo.html',
                'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
    ...
    def test_parse_championship_2011(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2011cmp.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        team_award = {
            'name_str':
            "Championship - Excellence in Design Award sponsored by Autodesk (3D CAD)",
            'award_type_enum':
    ...
    def test_parse_championship_2012(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2012cmp.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        multi_team_and_individual_award = {
            ...
            AwardType.DEANS_LIST,
            'team_number_list':
            [3059, 1540, 128, 1058, 3138, 3196, 1912, 2996, 842, 704],
            'recipient_json_list': [{
                'team_number': 3059,
                'awardee': u"Ikechukwa Chima"
            }, {
                'team_number': 1540,
                'awardee': u"Marina Dimitrov"
            }, {
                'team_number': 128,
                'awardee': u"Chase Douglas"
            }, {
                'team_number': 1058,
                'awardee': u"Tristan Evarts"
            }, {
                'team_number': 3138,
                'awardee': u"Danielle Gehron"
            }, {
                'team_number': 3196,
                'awardee': u"David Gomez"
            }, {
                'team_number': 1912,
                'awardee': u"Rachel Holladay"
            }, {
                'team_number': 2996,
                'awardee': u"Jasmine Kemper"
            }, {
                'team_number': 842,
                'awardee': u"John Rangel"
            }, {
                'team_number': 704,
                'awardee': u"Matthew Ricks"
            }],
        }
        self.assertTrue(multi_team_and_individual_award in awards)
        ...
        team_and_individual_award = {
            ...
            'recipient_json_list': [{
                'team_number': 2614,
                'awardee': u"Earl Scime"
            }],
        }
        self.assertTrue(team_and_individual_award in awards)

    def test_parse_championship_2013(self):
        with open('test_data/usfirst_html/usfirst_event_awards_2013cmp.html',
                  'r') as f:
            awards, _ = UsfirstEventAwardsParser.parse(f.read())
        ...
        new_award = {
            'name_str':
            "Dr. Bart Kamen Memorial Scholarship",
            'award_type_enum':
            AwardType.BART_KAMEN_MEMORIAL,
            'team_number_list': [],
            'recipient_json_list': [{
                'team_number': None,
                'awardee': "Sofia Dhanani"
            }, {
                'team_number': None,
                'awardee': "Sarah Rudasill"
            }, {
                'team_number': None,
                'awardee': "Pascale Wallace Patterson"
            }],
        }
        self.assertTrue(new_award in awards)
