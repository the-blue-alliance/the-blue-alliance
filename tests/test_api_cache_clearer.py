...
class TestApiCacheClearer(unittest2.TestCase):
    def setUp(self):
        ...
        self.team_events_frc1_cache_key = ApiTeamEventsController._get_full_cache_key(ApiTeamEventsController.CACHE_KEY_FORMAT.format('frc1', 2010))
        self.team_events_frc2_cache_key = ApiTeamEventsController._get_full_cache_key(ApiTeamEventsController.CACHE_KEY_FORMAT.format('frc2', 2010))
        self.team_event_awards_frc1_2010sc_cache_key = ApiTeamEventAwardsController._get_full_cache_key(ApiTeamEventAwardsController.CACHE_KEY_FORMAT.format('frc1', '2010sc'))
        self.team_event_awards_frc2_2010sc_cache_key = ApiTeamEventAwardsController._get_full_cache_key(ApiTeamEventAwardsController.CACHE_KEY_FORMAT.format('frc2', '2010sc'))
        self.team_event_matches_frc1_2010sc_cache_key = ApiTeamEventMatchesController._get_full_cache_key(ApiTeamEventMatchesController.CACHE_KEY_FORMAT.format('frc1', '2010sc'))
        self.team_event_matches_frc2_2010sc_cache_key = ApiTeamEventMatchesController._get_full_cache_key(ApiTeamEventMatchesController.CACHE_KEY_FORMAT.format('frc2', '2010sc'))
        ...
        self.team_years_participated_frc1_cache_key = ApiTeamYearsParticipatedController._get_full_cache_key(ApiTeamYearsParticipatedController.CACHE_KEY_FORMAT.format('frc1'))
        self.team_years_participated_frc2_cache_key = ApiTeamYearsParticipatedController._get_full_cache_key(ApiTeamYearsParticipatedController.CACHE_KEY_FORMAT.format('frc2'))
        self.team_list_page_0_cache_key = ApiTeamListController._get_full_cache_key(ApiTeamListController.CACHE_KEY_FORMAT.format(0))
        self.team_list_page_1_cache_key = ApiTeamListController._get_full_cache_key(ApiTeamListController.CACHE_KEY_FORMAT.format(1))
