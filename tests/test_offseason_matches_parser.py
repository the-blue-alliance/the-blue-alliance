...
class TestOffseasonMatchesParser(unittest2.TestCase):
    def test_parse(self):
        ...
        self.assertEqual(
            ...
            """{"blue": {"score": 8, "teams": ["frc4", "frc5", "frc6"]}, "red": {"score": 7, "teams": ["frc1", "frc2", "frc3"]}}"""
        )
        ...
        self.assertEqual(
            match["alliances_json"],
            """{"blue": {"score": -1, "teams": ["frc4", "frc5", "frc6"]}, "red": {"score": -1, "teams": ["frc1", "frc2", "frc3"]}}"""
        )
        ...
        self.assertEqual(
            match["alliances_json"],
            """{"blue": {"score": 8, "teams": ["frc4", "frc5", "frc6A"]}, "red": {"score": 7, "teams": ["frc1A", "frc2B", "frc3"]}}"""
        )
        ...
        self.assertEqual(
            match["alliances_json"],
            """{"blue": {"score": 8, "teams": ["frc1", "frc2", "frc6"]}, "red": {"score": 7, "teams": ["frc1B", "frc2B", "frc3"]}}"""
        )
